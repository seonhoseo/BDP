...
```bash
echo "export AIRFLOW__DATABASE__SQL_ALCHEMY_CONN='postgresql+psycopg2://bdpadmin:bdpadminPW%21@localhost:5432/airflow'" >> ~/.bashrc
...
```text
postgresql+psycopg2://bdpadmin:bdpadminPW%21@localhost:5432/airflow
```
...
```bash
python -c "import psycopg2; conn=psycopg2.connect('postgresql://bdpadmin:bdpadminPW%21@localhost:5432/airflow'); print('PostgreSQL connection OK'); conn.close()"
```
